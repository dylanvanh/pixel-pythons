  ...
  const recentMints = [
    {
      id: 1,
      number: "#123",
      image: "linear-gradient(to bottom right, #3b82f6, #1e3a8a)",
    },
    {
      id: 2,
      number: "#456",
      image: "linear-gradient(to bottom right, #10b981, #064e3b)",
    },
    {
      id: 3,
      number: "#789",
      image: "linear-gradient(to bottom right, #f59e0b, #92400e)",
    },
    {
      id: 4,
      number: "#101",
      image: "linear-gradient(to bottom right, #ef4444, #7f1d1d)",
    },
    {
      id: 5,
      number: "#202",
      image: "linear-gradient(to bottom right, #8b5cf6, #4c1d95)",
    },
  ];
